...
public:
	...
	virtual void OnEnterInventory(AZSCharacter* NewOwner);
...
public:
	...
	AZSCharacter* GetPawnOwner() const;
	...
	void SetOwningPawn(AZSCharacter* AZSCharacter);
...
protected:
	...
	virtual void FireWeapon() PURE_VIRTUAL(AZSWeapon::FireWeapon, );
